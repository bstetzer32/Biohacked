...
def upgrade():
    ...
    sa.Column('barbells', sa.String(length=10), nullable=False),
    sa.Column('dumbbells', sa.String(length=10), nullable=False),
    sa.Column('cables', sa.String(length=10), nullable=False),
    sa.Column('levers', sa.String(length=10), nullable=False),
